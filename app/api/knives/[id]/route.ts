...
export async function PATCH(request: Request, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const stringFields = ['name', 'brand', 'bladeStyle', 'handleMaterial', 'description', 'sourceUrl'] as const;
    ...
    if (body.images && Array.isArray(body.images) && body.images.every((item: unknown) => typeof item === 'string')) {
